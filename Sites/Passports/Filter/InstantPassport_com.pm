...
#############################################################
package Allied::Sites::Passports::Filter::InstantPassport_com;
#############################################################
...
sub _init {
	...
	$self->Allied::Sites::Passports::Filter::Default::_init($page);
        $self->{FILTER} = 'InstantPassport_com';
        $self->{CUSTOM_FILES_PATH} = '/usr/local/apache/files/Passports/instantpassport_com/';		# path to custom webiste files
        $self->{CONFIG_FILE} = '/usr/local/apache/files/Passports/instantpassport_com/InstantPassport_com.conf';
