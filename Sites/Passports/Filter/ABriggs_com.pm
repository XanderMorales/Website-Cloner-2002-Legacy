...
#############################################################
package Allied::Sites::Passports::Filter::ABriggs_com;
#############################################################
...
sub _init {
	...
	$self->Allied::Sites::Passports::Filter::Default::_init($page);
        $self->{FILTER} = 'ABriggs_com';
	$self->{CUSTOM_FILES_PATH} = '/usr/local/apache/files/Passports/abriggs_com/';		# path to custom webiste thtml files
        $self->{CONFIG_FILE} = '/usr/local/apache/files/Passports/abriggs_com/ABriggs_com.conf';
