...
#############################################################
package Allied::Sites::Passports::Filter::AAAInstantPassport_com;
#############################################################
...
sub _init {
	...
	$self->Allied::Sites::Passports::Filter::Default::_init($page);
        $self->{FILTER} = 'AAAInstantPassport_com';
        $self->{CUSTOM_FILES_PATH} = '/usr/local/apache/files/Passports/aaainstantpassport_com/';		# path to custom webiste files
        $self->{CONFIG_FILE} = '/usr/local/apache/files/Passports/aaainstantpassport_com/InstantPassport_com.conf';
