...
#############################################################
package Allied::Sites::Passports::Filter::Cruise411_InstantPassport_com;
#############################################################
...
sub _init {
	...
	$self->Allied::Sites::Passports::Filter::Default::_init($page);
        $self->{FILTER} = 'Demo_InstantPassport_com';
        $self->{CUSTOM_FILES_PATH} = '/usr/local/apache/files/Passports/SUB_DOMAIN/cruise411.passportexpress.com/';		# path to custom webiste files
        $self->{CONFIG_FILE} = '/usr/local/apache/files/Passports/SUB_DOMAIN/cruise411.passportexpress.com/PassportExpress_com.conf';
