...
#############################################################
package Allied::Sites::Passports::Filter::Taedge1_PassportExpress_com;
#############################################################
...
sub _init {
	...
	$self->Allied::Sites::Passports::Filter::Default::_init();
        $self->{FILTER} = 'Orbitz_PassportExpress_com';
        $self->{REQUESTED_PAGE} = $page;
        $self->_set_page($page);
	$self->{CUSTOM_FILES_PATH} = '/usr/local/apache/files/Passports/SUB_DOMAIN/taedge1.passportexpress_com/';		# path to custom webiste thtml files

	$self->{CONFIG_FILE} = '/usr/local/apache/files/Passports/SUB_DOMAIN/taedge1.passportexpress_com/PassportExpress_com.conf';
