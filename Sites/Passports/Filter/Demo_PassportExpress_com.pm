...
#############################################################
package Allied::Sites::Passports::Filter::Demo_PassportExpress_com;
#############################################################
...
sub _init {
	...
	$self->Allied::Sites::Passports::Filter::Default::_init();
        $self->{FILTER} = 'Demo_PassportExpress_com';
        $self->{REQUESTED_PAGE} = $page;
        $self->_set_page($page);
	$self->{CUSTOM_FILES_PATH} = '/usr/local/apache/files/Passports/SUB_DOMAIN/demo.passportexpress_com/';		# path to custom webiste thtml files

	$self->{CONFIG_FILE} = '/usr/local/apache/files/Passports/SUB_DOMAIN/demo.passportexpress_com/PassportExpress_com.conf';
