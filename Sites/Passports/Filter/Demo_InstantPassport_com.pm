...
#############################################################
package Allied::Sites::Passports::Filter::Demo_InstantPassport_com;
#############################################################
...
sub _init {
	...
	$self->Allied::Sites::Passports::Filter::Default::_init($page);
        ...
        $self->{CUSTOM_FILES_PATH} = '/usr/local/apache/files/Passports/SUB_DOMAIN/demo.instantpassport_com/';		# path to custom webiste files
        $self->{CONFIG_FILE} = '/usr/local/apache/files/Passports/SUB_DOMAIN/demo.instantpassport_com/InstantPassport_com.conf';
